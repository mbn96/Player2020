...
public class TimerChooseDialog extends BaseMbnDialog implements View.OnClickListener {
    public static final long ONE_MIN = 60 * 1000L;

    private TextView timeText;
    private MbnCircularSeekBar seekBar;
    private ImageButton cancelButt;
    private ImageButton deleteButt;
    private ImageButton okButt;
    ...
    public void onPrepareDialog() {
        View view = getLayoutInflater().inflate(R.layout.timer_choose_new_design, getDialogBase(), false);
        addLayout(view);
