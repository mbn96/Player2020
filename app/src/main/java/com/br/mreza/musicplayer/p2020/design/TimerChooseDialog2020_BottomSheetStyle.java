...
public class TimerChooseDialog2020_BottomSheetStyle extends BaseBottomSheetDialog implements View.OnClickListener {
...
//    }
    ...
    protected View getBottomLayout(ViewGroup c) {
        getStatusBarExtender().setAccentColor(getContext().getResources().getColor(R.color.mbn_background_for_appbar_super_ultra_light));
        View view = getLayoutInflater().inflate(R.layout.timer_choose_new_design_2020_bottom_sheet, getDialogBase(), false);
        timeText = view.findViewById(R.id.time_text);
        seekBar = view.findViewById(R.id.time_seekbar);
        seekBar.setOnChangeListener(seekBarListener);
        seekBar.setMaxValue(120);
