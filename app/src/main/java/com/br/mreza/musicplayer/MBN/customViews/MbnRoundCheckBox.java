...
public class MbnRoundCheckBox extends androidx.appcompat.widget.AppCompatCheckBox {
    ...
    public MbnRoundCheckBox(Context context) {
        super(context);
        init();
    }

    public MbnRoundCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MbnRoundCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        canvas.drawPath(pathForFill, paintForFill);
        if (mBitmap != null) {
            canvas.drawBitmap(mBitmap, 0, 0, paintForDraw);
        }
