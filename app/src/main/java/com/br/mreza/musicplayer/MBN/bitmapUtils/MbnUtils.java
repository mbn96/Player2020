...
//        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
    ...
    public static int colorWhitener(int color) {
        ...
        outR = (int) (255 - (Math.ceil((max - inR) / 20)));
        outB = (int) (255 - (Math.ceil((max - inB) / 20)));
        outG = (int) (255 - (Math.ceil((max - inG) / 20)));
    ...
    public static int colorAlphaChanger(int color, int alpha) {
