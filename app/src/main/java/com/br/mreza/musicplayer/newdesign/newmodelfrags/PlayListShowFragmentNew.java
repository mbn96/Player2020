...
public class PlayListShowFragmentNew extends BaseFragment {
...
//    }
    ...
    public static PlayListShowFragmentNew newInstance(int type, int id) {
        ...
        PlayListShowFragmentNew fragment = new PlayListShowFragmentNew();
    ...
    private void makeList(View view) {
        ...
        title = getToolbar().findViewById(R.id.playlist_name_text);
