...
class OptionMenuContainer extends FrameLayout {
    ...
    public void onPrepareDialog(int menuId) {
...
//        shapeDrawable.setColorFilter(Color.argb(215, 255, 255, 255), PorterDuff.Mode.SRC_IN);
        ...
        menuRecycler.setAdapter(new Adapter(getItems(menuId)));
    ...
    private class Adapter extends RecyclerView.Adapter<Adapter.Holder> {
        ...
        public Adapter(ArrayList<MenuItem> items) {
            this.items = items;
        }
        ...
        class Holder extends RecyclerView.ViewHolder {
            ...
            public Holder(View itemView) {
                ...
                itemView.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        dismiss();
                        fragManager.onMenuItemClicked(items.get(getAdapterPosition()).getItemId());
                    }
                });
            ...
            void onBind() {
                view.setIcon(items.get(getAdapterPosition()).getIcon());
                view.setText(items.get(getAdapterPosition()).getTitle().toString());
            }
