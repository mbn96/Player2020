...
public class MosaicMaker_Sync {

    public static final int MODE_NORMAL = 0;
    public static final int MODE_SIZE_VARY = 1;
    public static final int MODE_SIZE_VARY_COLORIZED = 2;
    public static final int MODE_CHARACTER = 3;

    public static final MosaicMaker_Sync INSTANCE = new MosaicMaker_Sync();
    private static final CharPixelCounter PIXEL_COUNTER = new CharPixelCounter();

    static {
        PIXEL_COUNTER.prepareWithRawString("QWERTYUIOPASDFGHJKLZXCVBNM123456789#/.,~%+;");
    }

    private MosaicMaker_Sync() {
    }

    public Bitmap makeMosaic(MosaicRequest request) {
        request.setup();
...
//            }
    ...
    private class SizeVaryItem extends CircleItem {
...
//            factor += factor < 0.5f ? (0.5f - factor) : 0;
    ...
    private class ColoredSizeVaryItem extends SizeVaryItem {
    ...
    private class CharacterItem extends SizeVaryItem {
...
//            CharPixelCounter charPixelCounter = (CharPixelCounter) request.optionalObject;
            String dChar = PIXEL_COUNTER.getCharacter((int) (getFactor() * 100));
