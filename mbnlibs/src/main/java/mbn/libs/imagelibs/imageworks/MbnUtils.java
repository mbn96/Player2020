...
public class MbnUtils {
    ...
    public static Bitmap roundedBitmap(Bitmap bitmap) {
        ...
        cropCircle.addCircle(cropSize / 2f, cropSize / 2f, cropSize / 2f, Path.Direction.CCW);
...
//        int height = bitmap.getHeight();
        ...
        cany.drawBitmap(bitmap, null, new Rect(0, 0, width, height), bitDrawPaint);
        return bity;
    }
...
//        return Color.argb(alpha, Color.red(color), Color.green(color), Color.blue(color));
    ...
    public static int colorShift(int color, int shift) {
        int a = color & 0xff000000;
        int r = ((color & 0xff0000) >>> shift) & 0xff0000;
        int g = ((color & 0xff00) >>> shift) & 0xff00;
        int b = (color & 0xff) >>> shift;
